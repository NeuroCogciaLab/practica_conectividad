"""
Script para ejecutar el análisis de conectividad de 1 sujeto con parcelación con el atlas de 100 ROI de Schaefer
"""
import os
...
func_files,
strategy = ("motion","wm_csf","ica_aroma","scrub"),
motion = "basic",
wm_csf = "basic",
ica_aroma = "basic"
)
