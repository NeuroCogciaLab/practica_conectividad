"""
Script para ejecutar el análisis de conectividad de 1 sujeto con parcelación con el atlas Yeo 17 Networks
"""
import os
...
correlation_matrix[0],
labels = [i for i in range(1,18,1)], 
auto_fit = True,reorder='single',
colorbar = True, 
vmax = 1,
vmin = -1,
tri = 'lower'
